...
from aws_cdk import (
    ...
    aws_events_targets as taergets,
...
class ApiEventBridgeLambdaStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        event_consumer1_lambda = _lambda.Function(self, "eventConsumer1Lambda",
                                                 runtime=_lambda.Runtime.PYTHON_3_9,
                                                 handler="event_consumer_lamda.lambda_handler",
                                                 code=_lambda.Code.from_asset("lambda")
                                                 )
        
        event_consumer1_rule = events.Rule(self, 'eventsConsumer1LambdaRule',
        ...
        event_consumer1_rule.add_target(targets.LambdaFunction(
            handler=event_consumer1_lambda)
            )
        ...
        event_consumer2_rule.add_target(targets.lambdaFunction(
            handler=event_consumer2_lambda)
            )
